...
export function updatePostComment(): MethodDecorator {
  return applyDecorators(
    ApiOperation({
      summary: POST_COMMENT_DESCRIPTION_MESSAGES.UPDATE_POST_COMMENT_API,
    }),

    ApiCreatedResponse({
      description:
        POST_COMMENT_DESCRIPTION_MESSAGES.UPDATE_POST_COMMENT_CREATED,
      type: PostCommentDto,
    }),
  );
}
